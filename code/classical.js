...
function GetOpinion(lvl_data, type) {
  ...
  switch (type) {
    ...
    case "ship":
      ...
      break;
    case "wave":
      $("#ratings-wave .rating").css("filter", "hue-rotate(" + hue + "deg)");
      ...
      break;
    case "swing":
      $("#ratings-swing .rating").css("filter", "hue-rotate(" + hue + "deg)");
      ...
      break;
    case "timing":
      $("#ratings-timing .rating").css("filter", "hue-rotate(" + hue + "deg)");
      ...
      break;
    case "cps":
      $("#ratings-cps .rating").css("filter", "hue-rotate(" + hue + "deg)");
