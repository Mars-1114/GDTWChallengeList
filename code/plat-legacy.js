...
function GetOpinion(lvl_data, type) {
  ...
  if (tot_weight == 0) {
    switch (type) {
        ...
        break;
        case "precision":
        $("#ratings-precision .rating").css("filter", "hue-rotate(0deg) saturate(0)");
        $("#ratings-precision .skillset").css("filter", "hue-rotate(0deg) brightness(0.5) saturate(0.8)");
        RatingTransition($("#ratings-precision .skillset"), 0);
        break;
        case "speed":
        $("#ratings-speed .rating").css("filter", "hue-rotate(0deg) saturate(0)");
        $("#ratings-speed .skillset").css("filter", "hue-rotate(0deg) brightness(0.5) saturate(0.8)");
        RatingTransition($("#ratings-speed .skillset"), 0);
        break;
        case "learny":
